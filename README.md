...
Current release: `v0.7.0`. This release adds LinkedIn JD auto capture, safer duplicate handling in the extension workspace, and tighter local sponsorship rejection rules. Build or refresh the DOL index from Settings before relying on employer-history evidence.
