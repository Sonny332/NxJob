...
from nxjob.db.repositories import create_application, get_application
from nxjob.schemas.core import ApplicationCreate, ApplicationRecord, ApplicationResponse
